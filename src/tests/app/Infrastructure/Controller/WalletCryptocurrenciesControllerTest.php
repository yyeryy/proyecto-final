...
class WalletCryptocurrenciesControllerTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $this->WalletCryptocurrenciesController = new WalletCryptocurrenciesController(
            $this->WalletCryptocurrenciesServiceMock
        );
    }
     ...
     * @test
     */
    public function getCorrectlyCryptocurrenciesTest()
    {
        $wallet = new Wallet('1');
        ...
        $this->assertInstanceOf(JsonResponse::class, $result);
        $this->assertJsonStringEqualsJsonString(
            '{"data":[{"coin_id":90,"name":"Bitcoin","symbol":"BTC","amount":1,"value_usd":27000}]}',
            $result->content()
        );
    }
